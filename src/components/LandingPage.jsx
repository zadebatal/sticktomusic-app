...
const LandingPage = ({ onLogin, onSignup, onGoogleAuth, authError, authLoading }) => {
  ...
  const faqItems = [
    {
      q: 'What platforms does StickToMusic support?',
      a: 'TikTok, Instagram, YouTube, and Facebook. Schedule posts to all platforms from one dashboard.',
    },
    {
      q: 'How does the Studio work?',
      a: 'Upload your clips, photos, and tracks. Our Studio remixes your media into ready-to-post videos and slideshows — professionally cut, synced to your music, at the click of a button.',
    },
    {
      q: 'How do I get access?',
      a: "Request a demo and we'll walk you through the platform. We work directly with labels and artist teams to build a package that fits your roster.",
    },
    {
      q: 'How many artists can I manage?',
      a: "There's no limit. Manage your entire roster from one dashboard — each artist gets their own isolated workspace.",
    },
    {
      q: 'Can my team use it too?',
      a: 'Absolutely. Add managers, collaborators, and artists to your account. Everyone gets the right level of access.',
    },
  ];
  ...
  return (
    <div
      className="flex h-screen w-full flex-col items-center bg-black overflow-auto focus:outline-none"
      tabIndex={0}
    >
      {/* NAV */}
      ...
      <div className="flex w-full max-w-[1280px] flex-col items-center gap-16 sm:gap-32 bg-black px-4 sm:px-12 py-12 sm:py-24">
          ...
          <div className="flex w-full max-w-[768px] flex-col items-center gap-8">
            <div className="flex w-full flex-col items-center gap-6">
              ...
              <span className="w-full text-heading-2 font-heading-2 text-brand-700 text-center">
                Create videos in seconds, schedule posts across every platform, and grow your
                audience systematically — all in one place.
              </span>
            </div>
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              <Button
                className="min-h-[48px] w-full sm:w-auto px-8"
                variant="brand-tertiary"
                size="large"
            ...
            {[
              {
                icon: <FeatherVideo />,
                title: 'Studio',
                desc: 'Drop in your clips, photos, and tracks. Our studio remixes your own media into hundreds of ready-to-post videos and slideshows — professionally cut, perfectly synced, at the click of a button.',
              },
              {
                icon: <FeatherCalendar />,
                title: 'Scheduler',
                desc: 'Schedule posts across TikTok, Instagram, YouTube, and Facebook from one dashboard. Stay consistent without the daily grind.',
              },
              {
                icon: <FeatherBarChart />,
                title: 'Analytics',
                desc: 'Track performance across all platforms. See what works, optimize your strategy, and grow your audience systematically.',
              },
            ].map((f, i) => (
              <div key={i} className="flex grow shrink-0 basis-0 flex-col items-start gap-4">
                <IconWithBackground
                  className="h-12 w-12 flex-none mx-auto"
                  variant="neutral"
                  size="large"
                  icon={f.icon}
                  square={false}
            ...
            {[
              {
                ...
                desc: 'Link your TikTok, Instagram, YouTube, and Facebook accounts in seconds.',
              },
              {
                num: '2',
                title: 'Create content',
                desc: 'Drop in your clips, photos, and tracks — our studio remixes them into hundreds of ready-to-post videos and slideshows at the click of a button.',
              },
              {
                num: '3',
                title: 'Schedule & grow',
                desc: 'Queue your posts, track analytics, and watch your audience grow across every platform.',
              },
            ].map((step, i) => (
              <div key={i} className="flex grow shrink-0 basis-0 flex-col items-center gap-4">
                ...
                <div className="flex w-full flex-col items-center gap-2">
                  <span className="text-heading-3 font-heading-3 text-white text-center">
                    {step.title}
                  </span>
                  <span className="text-body font-body text-brand-900 text-center">
                    {step.desc}
        ...
        <div className="flex w-full flex-col items-center gap-8">
          <div className="flex w-full max-w-[768px] flex-col items-center gap-4">
            ...
            <span className="text-body font-body text-brand-900 text-center">
              We work directly with labels and artist teams. Request a demo and we'll show you how
              StickToMusic fits your roster.
            </span>
          </div>
          <Button
            ...
            onClick={() =>
              (window.location.href =
                'mailto:info@sticktomusic.com?subject=StickToMusic Demo Request')
            }
          >
            Request a Demo
          </Button>
      ...
      <div className="flex w-full flex-col sm:flex-row items-center justify-between border-t border-solid border-neutral-200 bg-black px-4 sm:px-12 py-8 gap-4">
        ...
        <div className="flex items-center gap-6">
          <button
            ...
            className="text-caption font-caption text-neutral-400 hover:text-white transition-colors bg-transparent border-none cursor-pointer p-0"
          >
            Terms of Service
          </button>
          <button
          ...
          <a
            ...
            className="text-caption font-caption text-neutral-400 hover:text-white transition-colors no-underline"
          >
            Contact
          </a>
        </div>
      ...
      {showAuth && (
        ...
        >
          <div className="bg-[#0a0a0aff] border border-solid border-neutral-200 rounded-xl w-full max-w-md mx-4 px-8 py-8">
            ...
            {/* Tabs */}
            <div
              className="flex items-center rounded-lg border border-solid border-neutral-200 bg-black px-1 py-1 mb-6"
              role="tablist"
            >
              <button
                type="button"
              ...
              >
                <span
                  className={`text-sm ${authMode === 'login' ? 'text-default-font font-semibold' : 'text-neutral-400'}`}
                >
                  Login
                </span>
              </button>
              ...
              >
                <span
                  className={`text-sm ${authMode === 'signup' ? 'text-default-font font-semibold' : 'text-neutral-400'}`}
                >
                  Sign Up
                </span>
              </button>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1">
                ...
                {resetMessage && (
                  <div
                    className={`mt-1 text-xs ${resetMessage.type === 'success' ? 'text-green-400' : 'text-red-400'}`}
                  >
                    {resetMessage.text}
                  </div>
                )}
                ...
                <label className="flex items-start gap-2 cursor-pointer">
                  ...
                  <span className="text-xs text-neutral-400">
                    ...
                    <button
                      type="button"
                      onClick={() => navigate('/terms')}
                      className="text-brand-700 hover:text-white underline bg-transparent border-none p-0 cursor-pointer text-xs"
                    >
                      Terms of Service
                    </button>{' '}
                    and{' '}
              ...
              <Button
                ...
                size="large"
                disabled={authLoading || (authMode === 'signup' && !agreedToTerms)}
              >
                {authLoading ? (
