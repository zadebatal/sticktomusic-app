  ...
  return (
    <div className="absolute inset-0 bg-black/80 flex items-center justify-center z-[100]">
      <div className="bg-[#171717] rounded-xl p-6 max-w-[360px] w-full border border-neutral-200">
        <h3 className="text-[16px] font-semibold mb-2" style={{ color: theme.text.primary }}>
          Close editor?
        </h3>
        ...
        <div className="flex gap-2 justify-end">
          <Button variant="neutral-secondary" size="small" onClick={onKeepEditing}>
            Keep Editing
          </Button>
          <Button variant="destructive-primary" size="small" onClick={onClose}>
            Close Anyway
          </Button>
        </div>
      </div>
