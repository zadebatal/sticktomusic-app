      ...
      <div style={{
            ...
            <div style={{ padding: '8px 12px', borderBottom: `1px solid ${theme.border.subtle}`, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <button onClick={() => setShowTextPanel(false)} style={{ background: 'none', border: 'none', color: theme.text.muted, fontSize: '18px', cursor: 'pointer', padding: '2px 6px' }}>×</button>
                ...
                <div style={styles.tcTabs}>
                  <button
                    style={activeTab === 'caption' ? styles.tcTabActive : styles.tcTab}
                    onClick={() => setActiveTab('caption')}
                  >
                    Caption
                  </button>
                  <button
                    style={activeTab === 'styles' ? styles.tcTabActive : styles.tcTab}
                    onClick={() => setActiveTab('styles')}
                  >
                    Styles
                  </button>
                  <button
                    style={activeTab === 'lyrics' ? {...styles.tcTabActive, color: '#a78bfa'} : {...styles.tcTab, color: '#8b5cf6'}}
                ...
                {activeTab === 'caption' && (
                  <div style={styles.tcTabContent}>
                    ...
                    <div style={styles.tcControlRow}>
                      <div style={styles.tcControlGroup}>
                        <button
                          style={styles.tcSizeButton}
                          onClick={() => updateGlobalStyle(s => ({ ...s, fontSize: Math.max(24, s.fontSize - 4) }))}
                        >
                          A-
                        </button>
                        <button
                          style={styles.tcSizeButton}
                          onClick={() => updateGlobalStyle(s => ({ ...s, fontSize: Math.min(120, s.fontSize + 4) }))}
                        >
                          A+
                        </button>
                      </div>
                    ...
                    <div style={styles.tcControlRow}>
                      <button
                        style={!textStyle.outline ? styles.tcOptionButtonActive : styles.tcOptionButton}
                        onClick={() => updateGlobalStyle({ outline: false })}
                      >
                        No outline
                      </button>
                      <button
                        style={textStyle.outline ? styles.tcOptionButtonActive : styles.tcOptionButton}
                        onClick={() => updateGlobalStyle({ outline: true })}
                      >
                        Outline
                      </button>
                    </div>
                    ...
                    <div style={styles.tcControlRow}>
                      <button
                        style={textStyle.textCase === 'default' ? styles.tcCaseButtonActive : styles.tcCaseButton}
                        onClick={() => updateGlobalStyle({ textCase: 'default' })}
                      >
                        Default
                      </button>
                      <button
                        style={textStyle.textCase === 'lower' ? styles.tcCaseButtonActive : styles.tcCaseButton}
                        onClick={() => updateGlobalStyle({ textCase: 'lower' })}
                      >
                        lower
                      </button>
                      <button
                        style={textStyle.textCase === 'upper' ? styles.tcCaseButtonActive : styles.tcCaseButton}
                        onClick={() => updateGlobalStyle({ textCase: 'upper' })}
                      >
                        UPPER
                      </button>
                    </div>
                      ...
                      {textStyle.outline && (
                        <label style={styles.tcColorLabel}>
                          ...
                          <input
                            ...
                            onChange={(e) => updateGlobalStyle({ outlineColor: e.target.value })}
                            style={styles.tcColorInput}
                          />
                        </label>
                      )}
        ...
        <div style={styles.footer}>
          <div style={styles.footerLeft}>
            {/* Aspect ratio toggles — moved from header */}
